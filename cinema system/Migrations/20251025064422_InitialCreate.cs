        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenreMovie = table.Column<string>(nullable: true),
                    DescriptionMovie = table.Column<string>(nullable: true),
                    DurationMovie = table.Column<int>(nullable: false),
                    ReleaseDateMovie = table.Column<DateTime>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColumnSeat = table.Column<string>(nullable: true),
                    TypeSeat = table.Column<string>(nullable: true),
                    RoomId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceTicket = table.Column<decimal>(nullable: false),
                    StatusTicket = table.Column<string>(nullable: true),
                    ShowTimeId = table.Column<int>(nullable: false),
                    SeatId = table.Column<int>(nullable: false),
